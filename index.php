...
<body>
    ...
    <header class="container-fluid flex justify-space-between align-items-center flex-wrap grow shrink bg-black-500" id="top">
            ...
            <div class="products-card grid gap-1">
                ...
                <div class="card p-5 flex flex-column justify-start">
                    ...
                    <div class="product-details w-100 text-center">
                        ...
                        <p class="product font-extrabold text-2xl">Product</p>
