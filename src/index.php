...
<body>
    ...
    <div class="cookie-banner color-black flex justify-content-center align-items-center" id="cookie-banner">
    ...
    <a type="button" class="to-top absolute rounded-full" href="#top">
    ...
    <header class="container-fluid flex justify-content-space-between align-items-center flex-wrap grow shrink bg-black-500" id="top">
        <div class="flex gap-20">
            <a href="#" class="logo m-1">
        ...
        <div class="h-100 flex align-items-center gap-10 color-white shrink-0">
    ...
    <section class="container-fluid">
        <div class="section-4-grid grid gap-20">
